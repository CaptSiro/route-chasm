...
class PageNexusEditor extends NexusEditor {
    ...
    public function __construct(
        ...
        parent::__construct(
            ModelDescription::extract(Page::class),
            $this->pageBehavior = new PageEditorBehavior()
        );
    ...
    public function setContext(Nexus $context): static {
        $that = parent::setContext($context);

        $context->setTemplateSlot(Nexus::SLOT_BREAD_CRUMBS, $this->getBreadCrumbs());
        return $that;
    }
    ...
    public function getLocalizedTitle(): string {
        ...
        if (!is_null($dashboardLabel = $this->context->getDashboard()?->getDashboardLabel())) {
            $pageLabel = $this->tr($dashboardLabel . ' - Pages');
        } else {
    ...
    public function getGenerateStructureLink(): ?Url {
        if (is_null($url = $this->context->getCreateUrl())) {
            return null;
        }
    ...
    public function getTemplateEditorLink(): ?Url {
        if (is_null($this->model) || is_null($url = $this->context->getCreateUrl())) {
            return null;
        }
    ...
    public function render(): string {
        if (isset($this->context)) {
            $this->context->setTitle($this->getLocalizedTitle());
        }
